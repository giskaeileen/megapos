                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">MEGAPOS</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    {/* <ol className="flex text-gray-500 font-semibold dark:text-white-dark">
                        <li>
                            <button type="button">Nama Link Upercase</button>
                        </li>
                        <li className="before:content-['/'] before:px-1.5">
                            <button className="text-black dark:text-white-light hover:text-black/70 dark:hover:text-white-light/70">id dari entitas</button>
                        </li>
                    </ol> */}
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0">
                            ...
                            >
                                ...
                                <ul className="!px-2 text-dark dark:text-white-dark grid gap-2 font-semibold dark:text-white-light/90 w-[140px]">
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={
                                    <img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" 
                                        src={user.photo 
                                            ? `${import.meta.env.VITE_SERVER_URI_BASE}storage/profile/${user.photo}` 
                            ...
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li>
                                        <Link to={hasAdminRole ? 'settings' : 'settings-owner'} className="dark:hover:text-white">
