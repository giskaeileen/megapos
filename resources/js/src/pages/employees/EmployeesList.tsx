...
import { useDeleteEmployeeMutation, useGetEmployeesQuery } from '../../redux/features/employees/employeesApi';
...
const EmployeesList= () => {
    ...
    const deleteRow = () => {
        deleteConfirmation(selectedRecords, deleteEmployee, refetch, storeId);
    };
                        ...
                        <DataTable
                            ...
                            columns={[
                                ...
                                },
                                {
                                    accessor: 'salary',
                                    sortable: true,
                                    hidden: hideCols.includes('salary'),
                                },
                                {
                                    accessor: 'city',
                                    sortable: true,
